...
We have selected 6 key events based on the political and social impact (as judged by the authors) to the entire United States. This list is far from 
...
Of the six major national events analyzed only three clearly coresponded with a local minimum or maximum for combined anxiety and depression rates at the national level (fig. 1). The US Federal election on November 3, 2020 lines up well with the first and largest peak in our dataset for combined symptoms. Given that the federal response to the pandmic featured promenently in public discourse surrounded that election and that uncertainty is widely known to be associated with anxiety this correspondence makes sense. Equally unsurpirsing is the steep and persistent drop in anxiety and depression nationwide immediatly following the FDA approval of the first COVID-19 vaccines on December 11, 2020 (Park). 

The final aligned events of our triad, the overturning of Roe V. Wade (Totenberg and McCammon) on June 24, 2022 matches well to a small peak in anxiety and depression (fig. 1). As compared to the previous two events, the Roe V. Wade reversal is associated with a far less promenet change in the data. This moment is immediatly followed by a short delcine in symptom rates followed by a even larger peak in the neighborhood of the 2022 Midterm Elections on Novemeber 8, 2022. Both of these political events occur during a general upward movement in symptom rates nationwide but they are difficult to isolate from one another given their proximity. 

On the theme of major political events which are difficult to track over time we have included the start of the George Floyd protests on May 25, 2020 (George Floyd). These protests were not a single day event and the Black Lives Matter movement which expanded around this time does not have a clear start or end date yet was undoutedly a major contributor to the national mood and thus likley to rates of anxity and depression. We can see that May 25, 2020 lines up well with a local minimum in symptom rates which rise sharply after that date. 

The final event included in this analysis is the Federal Government's offical announcment of the end of the COVID-19 public health emergency on May 11, 2023 (End of the Federal COVID-19 Public Health Emergency). Given this annoucnment would appear to mark a major decrease in the burden of disease and or a change in the politial mood of the nation it is surprising to observe no major change in rates of anxiety or depression around this event (fig. 1). 
...
Though this paper primarily focuses on the percentage of the population expridince either anxiety or depresion it is worth noting that across the entire US at no time in our dataset did rates of depression symptoms exceed those of anxiety (fig. 2). 

Looking at the combined symptom rates around the first peak (11/11/2020 in fig. 2) we observe generally darker shading, indicating higher symptom rates, in the lower half of the contigous United States with New Mexico the worst state at 49.7% of the population exhitbing anxiety or depression symptoms. Flordia is a notable southern standout in the opposite direction with only 41.3% of the population showing symptoms. 

Combined symtome rates during the first major trough in the date--May 5, 2022--reveal an even more ovious divide between the Northern United states, specifically the Midwest, with lower scores than the Southern states especially those around Louisiana. 

While there is a persistent trend between North and South it should be noted that there is large variation in states regardless of lattidue between each two week time period (fig. 2). 
